...
In particular the Deep Learning field are powerful biologically inspired models that model how the model process sensory information. 
Deep Learning models achieve outstanding results in application where high dimensional data processing is needed and promise to solve yet unsolved problems such as medical diagnosis and autonomous driving.
...
\begin{figure}[h!]
  ...
  \centering
  \caption{LeNet-5 architecture. Hand written digit recognition in 28x28 gray scale images.}
  \label{fig:lenet}
\end{figure}
